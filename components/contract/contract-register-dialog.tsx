    ...
    try {
      ...
      await write({
        ...
        description: [
          ...
          '· 회사코드 = CP01~CP99 (회사정보에 미리 등록). 비우면 차량번호로 자동매칭 시도 (실패 시 등록 거부)',
          '· 차량번호 = 한국 형식 「12가1234」 또는 「123가1234」',
          '· 임차인 신분 = 드롭다운에서 [개인 / 개인사업자 / 법인] 중 선택',
          '· 고객등록번호 = 개인→주민번호(900101-1234567) / 개인사업자→사업자번호(123-45-67890) / 법인→법인등록번호(110111-0001234)',
          '· 날짜 (시작일·만기일·계약일) = YYYY-MM-DD 형식 (예: 2024-03-15) 또는 엑셀 날짜 셀',
          '· 미수금액 (필수) = 현재 누적 미수(원). 신규 계약은 0. 시스템이 최근 회차부터 거꾸로 차감해 자동 분배',
          '   예: 월 50만 / 미수 30만 → 마지막 도래 회차 부분납입(입금 20만/미수 30만), 그 이전 모두 완료',
          '· 결제방법 = 드롭다운에서 [자동이체 / 카드 / 인터넷뱅킹 / 현금 / 무통장 / 기타] 중 선택',
          '· 금액 컬럼은 천단위 콤마 자동 적용 — 콤마 안 찍어도 됨',
        ],
